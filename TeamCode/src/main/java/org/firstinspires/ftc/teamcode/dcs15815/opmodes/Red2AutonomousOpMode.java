...
@Autonomous(name = "Red Near 6a", group = "6a", preselectTeleOp = "Driver Operated")
public class Red2AutonomousOpMode extends DecodeAutonomousOpMode {
	...
	public void setup() {
		...
		.setDebugging(true)
	   	.startWithState(
			RunOnceState
				   .make(() -> {
						bot.navigation.setPosition("RED2_START");
