...
@Autonomous(name = "Red Far 6a", group = "6a", preselectTeleOp = "Driver Operated")
public class Red5AutonomousOpMode extends DecodeAutonomousOpMode {
	...
	public void setup() {
		...
		.setDebugging(true)
	   	.startWithState(
			RunOnceState
				   .make(() -> {
						bot.navigation.setPosition("RED5_START");
			...
			DecodeShootState
			 ...
			 DecodeShootState
				    .make()
				    .setBoost(DecodeConfiguration.RED5_SHOOTER_BOOST_SECOND_SET)
