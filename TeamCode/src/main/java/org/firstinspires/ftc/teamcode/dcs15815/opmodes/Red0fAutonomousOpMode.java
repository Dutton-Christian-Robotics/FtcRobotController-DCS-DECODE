...
@Autonomous(name = "Red Far 0a", group = "0a", preselectTeleOp = "Driver Operated")
public class Red0fAutonomousOpMode extends DecodeAutonomousOpMode {
	...
	public void setup() {
		...
		.setDebugging(true)
	   	.startWithState(
			RunOnceState
				   .make(() -> {
						bot.navigation.setPosition("RED0F_START");
				   })
				   .setLabel("START")
